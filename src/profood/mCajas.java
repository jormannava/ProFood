...
public class mCajas extends javax.swing.JFrame {
...
@SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jPanel1.add(etDire, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 220, 120, 30));
        ...
        jPanel1.add(etNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 210, 120, 30));
        ...
        jPanel1.add(lbId, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 150, 120, 30));
        ...
        jPanel1.add(lbId1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, 60, 30));

        lbId2.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        lbId2.setForeground(new java.awt.Color(0, 0, 0));
        lbId2.setText("Direccion:");
        jPanel1.add(lbId2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 150, 60, 30));
        ...
        jPanel1.add(lbId4, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 190, 60, 30));
        ...
        btDeliverySv1.setText("Visualizar");
        ...
        jPanel1.add(etFind, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 110, 120, 30));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 3, 24)); // NOI18N
        jLabel2.setText("Nueva Caja");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 210, 40));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 3, 24)); // NOI18N
        jLabel1.setText("Lista de Cajas");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 20, 210, 40));

        lbbt1.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        lbbt1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pics/primary.png"))); // NOI18N
        lbbt1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lbbt1MouseClicked(evt);
            }
        });
        jPanel1.add(lbbt1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 10, 290, 60));

        lbbt2.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        lbbt2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pics/dark.png"))); // NOI18N
        lbbt2.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        lbbt2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lbbt2MouseClicked(evt);
            }
        });
        jPanel1.add(lbbt2, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 10, 290, 60));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, -10, 610, 420));
    ...
    private void etFindKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_etFindKeyPressed
        ...
        if(evt.getKeyCode()==KeyEvent.VK_ENTER)  { try {
            ...
            Logger.getLogger(mCajas.class.getName()).log(Level.SEVERE, null, ex);
        }}
    ...
    private void lbbt1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbbt1MouseClicked
  ImageIcon primary = new ImageIcon(getClass().getResource("primary.png"));
  
        lbbt1.setIcon(primary);
        
   ImageIcon dark = new ImageIcon(getClass().getResource("dark.png"));
  
        lbbt2.setIcon(dark);
    }//GEN-LAST:event_lbbt1MouseClicked

    private void lbbt2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbbt2MouseClicked
   ImageIcon primary = new ImageIcon(getClass().getResource("primary.png"));
  
        lbbt2.setIcon(primary);
        
   ImageIcon dark = new ImageIcon(getClass().getResource("dark.png"));
  
        lbbt1.setIcon(dark);
    }//GEN-LAST:event_lbbt2MouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mCajas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
